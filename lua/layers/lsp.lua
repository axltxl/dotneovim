...
local function setup_keymappings()
    ...
    keys.map_n('gd', vim.diagnostic.open_float, { desc = 'popup diagnostic' })
    keys.map_n('[d', vim.diagnostic.goto_prev, { desc = 'go to previous diagnostic' })
    keys.map_n(']d', vim.diagnostic.goto_next, { desc = 'go to next diagnostic' })
